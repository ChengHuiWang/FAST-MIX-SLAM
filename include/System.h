...
#ifndef MIX_SYSTEM_H_
#define MIX_SYSTEM_H_
...
namespace mix {
    ...
    public:
        ...
        */
        ...
        void SaveTrajectory(const string &filename);//保存单目数据
...
/////////////////////////////////////////////////////////自定义//////////////////////////////////////////////////////////////
	...
	float *ExposureTime_Sys;              //Sparse曝光时间
        int nimg_Sys = 0;
	void getExposureTime_Sys(float *);
	void getNImage_Sys(int ); 
