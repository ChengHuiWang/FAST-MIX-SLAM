...
#ifndef MIX_TRACKING_H_
#define MIX_TRACKING_H_
...
namespace mix {
    ...
    public:
        ...
        // Use this function if you have deactivated使失效 local mapping and you only want to localize the camera.定位模式
...
/////////////////////////////////////////////////////////自定义//////////////////////////////////////////////////////////////
	...
	float *ExposureTime_T;              //曝光时间
        int nimg_T = 0;
	int  KeyFrameToFrameID[1000];
	void getExposureTime_T(float *);
	void getNImage_T(int ); 
