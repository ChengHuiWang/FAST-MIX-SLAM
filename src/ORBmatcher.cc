...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
        ...
        bool success = mix::Align2D(curr->mvImagePyramid[search_level], _patch_with_border, _patch, 10, px_scaled,
				    ExposureTime_O, ref->mnFrameId,curr->mnId );
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////       
	...
	px_curr = px_scaled * curr->mvScaleFactors[search_level];
     ...
     void  ORBmatcher::getExposureTime_O(float *T)
    {
        ExposureTime_O=T;
    }

    void  ORBmatcher::getNImage_O(int N )
   {
        nimg_O=N;
   }
    
    void  ORBmatcher::getReferForAlignID_O(int N )
   {
        ReferForAlignID_O=N;
   }
