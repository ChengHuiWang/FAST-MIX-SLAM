...
namespace mix {
    ...
    SE3f Tracking::GrabImageMonoVI(const cv::Mat &im, const std::vector<IMUData> &vimu, const double &timestamp) {
        mvIMUSinceLastKF.insert(mvIMUSinceLastKF.end(), vimu.begin(), vimu.end());//全局单目VI（mix加的）
        mImGray = im;
...
//-------------------------------------------------------------------------------------------
    ...
    Tracking::Tracking(
        ...
        mpAlign = new mix::SparseImgAlign(nLevels - 1, 1);//--
 ...
 */
	...
	//cout<<"pKF->mnId="<<pKF->mnId<<";  nimg_T="<<nimg_T<<endl;
	//cout<<"pKF->mnFrameId="<<pKF->mnFrameId<<";  nimg_T="<<nimg_T<<endl;
...
//////////////////////////////////////////////////////自定义///////////////////////////////////////////////////////
        ...
        mpAlign->getExposureTime(ExposureTime_T);
	mpAlign->getNImages(nimg_T);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////
		     ...
		     matcher.getExposureTime_O(ExposureTime_T);
	             matcher.getNImage_O(nimg_T ); 
	             matcher.getReferForAlignID_O(o.first->mnFrameId );   
               //    cout<<" o.first->mnFrameId "<<o.first->mnFrameId<<endl;
               //  cout<<" currentFrameId "<<nimg_T<<endl;
///////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void Tracking::getExposureTime_T(float *T)
  {
       ExposureTime_T=T;
  }

  void Tracking::getNImage_T(int N )
  {
       nimg_T=N;
  }
