...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool System::GetLocalMapAcceptKF() {//接受局部地图关键帧
    ...
    cv::Mat System::TrackMonoVI(const cv::Mat &im, const std::vector<IMUData> &vimu, const double &timestamp) {//imu线程
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
        ...
        LOG(INFO) <<
                  "This is MIX-SLAM, forked from ORB-SLAM proposed by Raul Mur-Artal, University of Zaragoza." << endl
                  <<
    ...
    cv::Mat System::TrackMonocular(const cv::Mat &im, const double &timestamp) {//主线程调用Tracking的入口
        if (mSensor != MONOCULAR) {
            cerr << "ERROR: you called TrackMonocular but input sensor was not set to Monocular." << endl;
            exit(-1);
        }
...
///////////////////////////////////////////////自定义/////////////////////////////////////////////////////////
        ...
        mpTracker->getExposureTime_T(ExposureTime_Sys);
        mpTracker->getNImage_T(nimg_Sys);
	 
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        
	//cout<<"ExposureTime_Sys="<<ExposureTime_Sys[nimg_Sys]<<endl;
    ...
    /*  void System::SaveTrajectory(const string &filename)//保存单目数据
    {
              cout << endl << "Saving camera trajectory to " << filename << " ..." << endl;
   ...
   void System::getExposureTime_Sys(float *T)
  {
       ExposureTime_Sys=T;
  }

   void System::getNImage_Sys(int N )
  {
       nimg_Sys=N;
  }
